...
<p class="summary">订单号：<span>{orderid}</span></p><p class="summary">支出：<span>人民币 {price} 元</span></p><p class="summary">收入：<span>{value}</span></p>',
	...
	'manage_verifythread' => '有新的待审核主题。<a href="adminMasters.php?action=moderate&operation=threads&dateline=all">现在进行审核</a>',
	'manage_verifypost' => '有新的待审核回帖。<a href="adminMasters.php?action=moderate&operation=replies&dateline=all">现在进行审核</a>',
	'manage_verifyuser' => '有新的待审核会员。<a href="adminMasters.php?action=moderate&operation=members">现在进行审核</a>',
	'manage_verifyblog' => '有新的待审核日志。<a href="adminMasters.php?action=moderate&operation=blogs">现在进行审核</a>',
	'manage_verifydoing' => '有新的待审核记录。<a href="adminMasters.php?action=moderate&operation=doings">现在进行审核</a>',
	'manage_verifypic' => '有新的待审核图片。<a href="adminMasters.php?action=moderate&operation=pictures">现在进行审核</a>',
	'manage_verifyshare' => '有新的待审核分享。<a href="adminMasters.php?action=moderate&operation=shares">现在进行审核</a>',
	'manage_verifycommontes' => '有新的待审核留言/评论。<a href="adminMasters.php?action=moderate&operation=comments">现在进行审核</a>',
	'manage_verifyrecycle' => '回收站有新的待处理主题。<a href="adminMasters.php?action=recyclebin">现在处理</a>',
	'manage_verifyrecyclepost' => '回帖回收站有新的待处理回帖。<a href="adminMasters.php?action=recyclebinpost">现在处理</a>',
	'manage_verifyarticle' => '有新的待审核文章。<a href="adminMasters.php?action=moderate&operation=articles">现在进行审核</a>',
	'manage_verifymedal' => '有新的待审核勋章申请。<a href="adminMasters.php?action=medals&operation=mod">现在进行审核</a>',
	'manage_verifyacommont' => '有新的待审核文章评论。<a href="adminMasters.php?action=moderate&operation=articlecomments">现在进行审核</a>',
	'manage_verifytopiccommont' => '有新的待审核专题评论。<a href="adminMasters.php?action=moderate&operation=topiccomments">现在进行审核</a>',
	'manage_verify_field' => '有新的待处理{verifyname}。<a href="adminMasters.php?action=verify&operation=verify&do={doid}">现在处理</a>',
	...
	'new_report' => '有新的举报等待处理，<a href="adminMasters.php?action=report" target="_blank">点此进入后台处理</a>。',
